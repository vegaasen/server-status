package com.vegaasen.status.run.container;
...
public class StartJettyContainer {
    ...
    public static void initiateAndStartServer() {
        ...
        // To run without any problems: target/status/WEB-INF/status.xml (or whatever that is defined as the "finalName")
        webAppContext.setDescriptor(location.toExternalForm() + "WEB-INF/status.xml");
        webAppContext.setTempDirectory(null);
        // To run without any problems: target/status (or whatever that is defined as the "finalName")
